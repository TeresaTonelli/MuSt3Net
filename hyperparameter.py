...
dict_season = {"winter":[1, 13], "spring": [14, 24], "summer":[25, 39], "autumn": [40, 53], "winter_bloom":[5, 18], "DCM":[20, 39]}      #{"winter":[1, 13], "summer":[14, 53]}
dict_ga = {
    'NWM': [[-2, 9.5], [40, 45]],
    'SWM': [[-2, 9.5], [32, 40]],
    'TYR': [[9.5, 16], [37, 45]],
    'ION': [[15, 22], [30, 42]],   #[[9.5, 22], [37, 45]]
    'LEV': [[22, 36], [30, 37]]
}
dict_indexes_ga = {'NWM': [[13, 173], [138, 208]],
    'SWM': [[13, 173], [27, 138]],
    'TYR': [[173, 263], [97, 208]],
    'ION': [[249, 346], [0, 194]],   #[[173, 346], [36, 44]]
    'LEV': [[346, 541], [0, 97]]}
